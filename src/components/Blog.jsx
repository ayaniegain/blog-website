...
function Blog() {
  return (
      ...
      {blogsData.map((item) => (
        <div key={item.id} className="flex  bg-gray-700 p-6 w-400 w-4/6  rounded-lg mb-6">
          <img
            src={item.image}
            alt={item.title}
            className="w-1/3 h-48 object-cover rounded-lg mr-6"
          />
          <div className="flex flex-col justify-between ">
            ...
            <Link
              ...
              className="bg-green-500 text-white py-2 px-4 rounded w-20 flex justify-center inline-block"
            >
              View
            </Link>
          </div>
